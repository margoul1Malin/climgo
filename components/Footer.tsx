...
export default function Footer() {
  const [contact, setContact] = useState({ adress: '', phone: '', mail: '' });
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services/chauffage" className="text-gray-400 hover:text-white transition-colors">Chauffage</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">{contact.mail || '—'}</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-400">{contact.adress || '—'}</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="flex space-x-4 justify-end mb-8 text-center text-sm w-full">
              <Link href="/legal/terms" className="text-gray-400 hover:text-white transition-colors">Politique de confidentialité</Link>
              <Link href="/legal/legal-mentions" className="text-gray-400 hover:text-white transition-colors">Mentions Légales</Link>
        </div>
